...
/**/mE.srcRootDir = path.resolve(mE.staticRootDir, './example-admin-1-multiple-page'); // 项目业务代码根目录
/**//**/mE.buildDir = path.resolve(mE.srcRootDir, '../../2vbuild'); // 存放编译后生成的所有代码、资源（图片、字体等，虽然只是简单的从源目录迁移过来）
